...
{
  AccountSetting(FirebaseAuth auth)
  {
    _AccountSettingState.auth=auth;
    }
  @override
     createState() => _AccountSettingState();
}
...
class _AccountSettingState extends State<AccountSetting> {
          ...
          RaisedButton(
              ...
              onPressed: (){
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => UpdateProfilePage(auth)));
              }),
          RaisedButton(
  ...
  void getValue(DataSnapshot snap) {
    ...
    Navigator.push(context,MaterialPageRoute(builder: (context) =>CheckProfile(ProfileList,auth)));
  }
  }
